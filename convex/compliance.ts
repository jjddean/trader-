...
const GROUPS: Record<string, string[]> = {
    group1: [ // Africa
        ...
        "Guinea-Bissau", "Liberia", "Madagascar", "Malawi", "Mali", "Mauritania", "Mozambique",
        "Niger", "Rwanda", "Senegal", "Sierra Leone", "Somalia", "South Sudan", "Sudan",
        "Tanzania", "Togo", "Uganda", "Zambia", "Cameroon", "Cape Verde", "Comoros",
        "Republic of Congo", "Côte d'Ivoire", "Eswatini", "Ghana", "Kenya", "Lesotho",
        "Mauritius", "Morocco", "Zimbabwe", "Botswana", "Namibia", "Nigeria"
    ],
    group2: [ // ASEAN
        "Brunei", "Cambodia", "Indonesia", "Laos", "Myanmar", "Philippines", "Vietnam"
    ],
    group3: [ // SAARC
    ...
    handler: async (ctx, args) => {
        ...
        const tiers: Record<string, string[]> = {
            "Comprehensive": [
                ...
                "Mauritania", "Mozambique", "Myanmar", "Nepal", "Niger", "Rwanda", "São Tomé and Príncipe",
        ...
        return { eligible: false, tier: "None", duty: "MFN (Standard UK Global Tariff)", confidence: 1.0 };
    },
});
...
export const simulateRoO = mutation({
    ...
    handler: async (ctx, args) => {
        ...
        const totalValue = (args.valueOrigin + args.valueUK + args.valueThirdParty) + (args.materials?.reduce((acc, m) => acc + m.value, 0) || 0);
