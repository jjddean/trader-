  ...
  return (
    <div className="space-y-6 p-8">
      ...
      <div className="overflow-hidden rounded-xl border border-gray-200 bg-white">
        {filtered.length === 0 ? (
          <p className="px-6 py-12 text-center text-xs text-gray-500">No declarations match.</p>
        ) : (
          <table className="w-full border-collapse text-left">
            <thead>
              <tr className="border-b border-gray-200 bg-gray-50/80">
                <th className="px-6 py-3 text-[10px] font-semibold uppercase tracking-wider text-gray-500">MRN / LRN</th>
                <th className="px-6 py-3 text-[10px] font-semibold uppercase tracking-wider text-gray-500">Owner</th>
                <th className="px-6 py-3 text-[10px] font-semibold uppercase tracking-wider text-gray-500">EORI</th>
                <th className="px-6 py-3 text-[10px] font-semibold uppercase tracking-wider text-gray-500">Updated</th>
                <th className="px-6 py-3 text-[10px] font-semibold uppercase tracking-wider text-gray-500">Status</th>
                <th className="px-6 py-3 text-right text-[10px] font-semibold uppercase tracking-wider text-gray-500">Open</th>
              </tr>
            </thead>
              ...
              {filtered.map((row) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-xs text-gray-600">{row.ownerEmail || "—"}</td>
                    <td className="px-6 py-4 text-xs text-gray-600">{row.eori || "—"}</td>
                    ...
                    <td className="px-6 py-4 text-right">
                      <Link
                        ...
                        className="inline-flex items-center gap-1 text-[10px] font-semibold text-gray-500 opacity-0 group-hover:opacity-100"
                      >
