...
export default function DashboardLayout({
  ...
  > = {
    ...
    "/dashboard/audit": { title: "Export Controls", badge: "EXPORT", badgeVariant: "default" },
    "/dashboard/trade-compliance": { title: "Export Controls", badge: "EXPORT", badgeVariant: "default" },
