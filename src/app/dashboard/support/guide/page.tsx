...
export default function UserGuidePage() {
  ...
  return (
    <div className="mx-auto flex h-full max-w-[800px] flex-col px-8 py-12">
      <div className="mb-8">
        <h1 className="text-2xl font-bold tracking-tight text-slate-900 mb-2">User Guide</h1>
      ...
      <div className="flex flex-col gap-4">
        {sections.map((section, idx) => (
          <div key={idx} className="rounded-[4px] border border-slate-200 bg-white p-6 shadow-sm">
      ...
      <div className="mt-12 text-center rounded-[4px] border border-slate-200 bg-slate-50 p-6">
        <h3 className="text-sm font-semibold text-slate-900 mb-2">Still need help?</h3>
