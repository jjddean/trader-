...
export default function DocumentsPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-lg font-medium text-slate-900">Secure Document Upload</h2>
      ...
      <div className={`rounded-xl border border-slate-200 bg-white overflow-hidden transition-opacity ${isLocked ? "opacity-50 pointer-events-none" : ""}`}>
        <div className="p-8">
          <div
            className="flex flex-col items-center justify-center border-2 border-dashed border-slate-200 rounded-lg p-12 bg-slate-50/50 hover:bg-slate-50 transition-colors relative"
            onDrop={handleDrop}
          ...
          >
            ...
            {isUploading ? (
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-sm font-medium text-slate-900">Transmitting to HMRC Upscan...</p>
                <p className="text-xs text-slate-500 mt-1">Awaiting anti-virus scan results</p>
              </div>
            ) : (
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="text-sm font-bold text-slate-900">Click or drag file to upload</h3>
                <p className="mt-1 text-xs text-slate-500 max-w-xs">
                  Securely upload Commercial Invoices, Packing Lists, or Certificates of Origin.
                </p>
                <div className="mt-4 flex gap-2 justify-center text-[10px] uppercase font-bold text-slate-400">
            ...
            <div className="mt-8 space-y-4">
              ...
              <div className="space-y-2">
                {uploadedFiles.map((file, i) => (
                  <div key={i} className="flex items-center justify-between p-3 border border-slate-100 rounded-md bg-slate-50">
