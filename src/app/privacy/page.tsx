  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="mx-auto max-w-3xl px-6 py-24">
        ...
        <p className="mb-12 text-[13px] text-slate-500">Last updated: 13 February 2026</p>
        ...
        <div className="text-[15px] leading-relaxed text-slate-700">
          ...
          <h2 className="mb-4 mt-8 text-[20px] font-semibold tracking-tight text-slate-900">1. Information We Collect</h2>
          <p className="mb-4">To provide our analytics and automation tools, we collect and process:</p>
          ...
          <h2 className="mb-4 mt-8 text-[20px] font-semibold tracking-tight text-slate-900">2. AI Processing &amp; Invoice Extraction</h2>
          <p className="mb-6">
          ...
          <h2 className="mb-4 mt-8 text-[20px] font-semibold tracking-tight text-slate-900">3. How We Use Information</h2>
          <p className="mb-4">We use the processed information strictly to:</p>
          <ul className="mb-6 list-disc space-y-2 pl-6">
          ...
          <h2 className="mb-4 mt-8 text-[20px] font-semibold tracking-tight text-slate-900">4. Sharing of Information</h2>
          <p className="mb-4">We never sell your trade data. Information is only shared securely with:</p>
          <ul className="mb-6 list-disc space-y-2 pl-6">
          ...
          <h2 className="mb-4 mt-8 text-[20px] font-semibold tracking-tight text-slate-900">5. Data Retention &amp; Security</h2>
          <p className="mb-6">
          ...
          <h2 className="mb-4 mt-8 text-[20px] font-semibold tracking-tight text-slate-900">6. Your Rights</h2>
          <p>
            ...
            <a href="/dashboard/settings?tab=privacy" className="font-semibold text-blue-600 hover:text-blue-700 hover:underline">
            ...
            <a href="mailto:info@freightcode.co.uk" className="font-semibold text-blue-600 hover:text-blue-700 hover:underline">info@freightcode.co.uk</a>
          </p>
        </div>
      </div>
    </div>
