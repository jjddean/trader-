  ...
  return (
    <div className="space-y-8">
        ...
        {STRIPE_PLAN_CARDS.map((plan) => (
          <div
            ...
            className={cn(
              ...
              plan.highlighted ? "border-gray-900 shadow-sm" : "border-gray-200",
            )}
          >
            <div className="mb-4">
              ...
              <p className="mt-2 text-2xl font-semibold tracking-tight text-gray-900">
                {plan.price}
                <span className="ml-1 text-xs font-normal text-gray-500">{plan.interval}</span>
              </p>
            ...
            <Button
              type="button"
              className={cn("h-9 w-full text-xs", plan.highlighted ? "bg-black hover:bg-gray-800" : "")}
      ...
      <div className="rounded-xl border border-dashed border-gray-200 bg-gray-50 px-5 py-4 text-center">
        <p className="text-sm font-medium text-gray-800">{CUSTOM_PLAN.label}</p>
        <p className="mt-1 text-xs text-gray-500">{CUSTOM_PLAN.description}</p>
