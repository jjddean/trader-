# Safety and security import declarations service guide — overview

> Source: https://developer.service.hmrc.gov.uk/guides/safety-and-security-import-declarations-end-to-end-service-guide/
...
Version 1.9 issued 5 August 2025
...
The reduced dataset consists of 20 mandatory fields, up to 8 conditional fields (which need to be completed in certain circumstances), and 9 optional data fields. Further information on the reduced dataset can be found here within Annex A.
...
- Additional information can be found at Import Control System: support for software developers )
