...
**Source:** Live TT runs in this repo (`docs/hmrc/ARCHIVE/trade-test/lane.md`, `docs/hmrc/ARCHIVE/trade-test/evidence/passing/notification-audit-FC-MPYAJ7RN.md`, cancel evidence `evidence/04-cancel/`).
...
**Do not expect DMSCLE** on an MRN that stays **Accepted** only. `docs/hmrc/ARCHIVE/trade-test/lane.md` documents: *DMSCLE not on this MRN* for the passing lane.
